...
package sifive.freedom.everywhere.e300ebaz4205devkit
...
//-------------------------------------------------------------------------
// E300Ebaz4205DevKitPlatformIO
//-------------------------------------------------------------------------

class E300Ebaz4205DevKitPlatformIO(implicit val p: Parameters) extends Bundle {
  val pins = new Bundle {
...
//-------------------------------------------------------------------------
// E300Ebaz4205DevKitPlatform
//-------------------------------------------------------------------------

class E300Ebaz4205DevKitPlatform(implicit val p: Parameters) extends Module {
  val sys = Module(LazyModule(new E300Ebaz4205DevKitSystem).module)
  val io = new E300Ebaz4205DevKitPlatformIO
