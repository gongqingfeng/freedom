...
import sifive.fpgashells.shell.xilinx.ebaz4205shell.{Ebaz4205Shell}
import sifive.fpgashells.ip.xilinx.{IBUFG, IOBUF, PULLUP, PowerOnResetFPGAOnly}

//-------------------------------------------------------------------------
// E300Ebaz4205DevKitFPGAChip
//-------------------------------------------------------------------------

class E300Ebaz4205DevKitFPGAChip(implicit override val p: Parameters) extends Ebaz4205Shell {
  ...
  withClockAndReset(clock_32MHz, ck_rst) {
    val dut = Module(new E300Ebaz4205DevKitPlatform)
    ...
    // Mirror outputs of GPIOs with PWM peripherals to RGB LEDs on Ebaz4205
